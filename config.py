...
class SearchConfig(BaseConfig):
    ...
    def build_parser(self):
        ...
        parser.add_argument('--saved_dataset',
                            default='MRPC-nas', help='input dataset')
        parser.add_argument('--batch_size', type=int,
                            default=32, help='batch size')
        parser.add_argument('--w_lr', type=float,
                            default=0.02, help='lr for weights')
        ...
        parser.add_argument('--w_weight_decay', type=float,
                            default=3e-4, help='weight decay for weights')
        parser.add_argument('--w_grad_clip', type=float,
        ...
        parser.add_argument('--limit', type=int,
                            default=128, help='max length')
        parser.add_argument('--char_limit', type=int,
                            default=12, help='max length')
        parser.add_argument('--stem_multiplier', type=int,
                            default=1, help='# of stem_multiplier')
        parser.add_argument('--d_vec', type=int,
                            default=300, help='# of nodes')
        parser.add_argument('--d_cvec', type=int,
                            default=50, help='# of nodes')
        parser.add_argument('--n_classes', type=int,
                            default=2, help='# of classes')
        parser.add_argument('--workers', type=int,
                            default=0, help='# of workers')
        parser.add_argument('--max_word_v_size', type=int,
                            default=100000, help='max word num')
        parser.add_argument('--max_char_v_size', type=int,
                            default=200, help='max char num')
        parser.add_argument('--load_tasks', type=int,
                            default=1, help='load pickle glue data')

        parser.add_argument('--one_step', type=str2bool,
                            default=False, help='# of layers')
        parser.add_argument('--random_sample_epoch',
                            type=int, default=0, help='# of layers')
        parser.add_argument('--freeze_alpha', type=int,
                            default=0, help='# of layers')

        parser.add_argument('--distributed', type=bool,
                            default=False, help='# of layers')
        parser.add_argument('--n_gpu', type=int, default=1, help='# of layers')
        parser.add_argument('--local_rank', type=int,
                            default=-1, help='# of training epochs')

        parser.add_argument('--teacher_model', type=str,
                            default='teacher_utils/teacher_model/RTE', help='# of layers')
        parser.add_argument('--use_kd', type=str2bool,
                            default=True, help='# of layers')
        parser.add_argument('--use_emd', type=str2bool,
                            default=True, help='# of layers')
        parser.add_argument('--kd_alpha', type=float,
                            default=0.8, help='# of layers')
        parser.add_argument('--emd_rate', type=float,
                            default=0.0, help='# of layers')
        parser.add_argument('--update_emd', type=str2bool,
                            default=False, help='# of layers')

        parser.add_argument('--seed', type=int, default=2, help='random seed')
        parser.add_argument('--log_name', type=str,
                            default="", help='load pickle glue data')
        parser.add_argument('--emd_only', type=str2bool,
                            default=False, help='# of layers')
        parser.add_argument('--save_supernet', type=str,
                            default="", help='# of layers')
        parser.add_argument('--restore', type=str,
                            default="", help='# of layers')
        parser.add_argument('--alpha_only', type=str2bool,
                            default=False, help='# of layers')
        parser.add_argument('--alpha_optim', type=str,
                            default='adam', help='# of layers')
        parser.add_argument('--eval_during_train',
                            type=str2bool, default=False, help='# of layers')
        parser.add_argument('--l1', type=float,
                            default=0.001, help='# of layers')
        parser.add_argument('--_temp', type=float,
                            default=1.0, help='# of layers')
        parser.add_argument('--tb_dir', type=str,
                            default="", help='# of layers')
        parser.add_argument('--t_att_type', type=str,
                            default="", help='# of layers')
        parser.add_argument('--s_att_type', type=str,
                            default="", help='# of layers')
        parser.add_argument('--hidn2attn', type=str2bool,
                            default=False, help='# of layers')
        parser.add_argument('--add_op', type=str,
                            default='cnn', help='# of layers')
        parser.add_argument('--rnn_op', type=bool,
                            default=False, help='# of layers')
        parser.add_argument('--mul_att_out', type=bool,
                            default=False, help='# of layers')
        parser.add_argument('--sep_alpha', type=bool,
                            default=False, help='# of layers')
        parser.add_argument('--alpha_ac_rate', type=float,
                            default=0.0, help='# of layers')
        parser.add_argument('--alpha_ep', type=int,
                            default=-1, help='# of layers')
        parser.add_argument('--weight_rate', type=float,
                            default=1.0, help='# of layers')
        parser.add_argument('--add_softmax', type=str2bool,
                            default=True, help='# of layers')
    ...
    def __init__(self):
        ...
        print("=============MODEL CONFIG==============")
        print("task={}\nlayer={}\nhidden={}\nbatch_size={}\nepochs={}".format(
            self.datasets, self.layers, self.init_channels, self.batch_size, self.epochs))
        print("=============KD CONFIG==============")
        print("use KD={}\nuse emd={}\nkd ALPHA={}\none_step={}\nrandom epoch={}\nfreeze epoch={}\ntrain alpha only={}\nemd only={}".format(
            self.use_kd, self.use_emd, self.kd_alpha, self.one_step, self.random_sample_epoch, self.freeze_alpha, self.alpha_only, self.emd_only))
...
class AugmentConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--max_seq_length', type=int,
                            default=128, help='# of layers')
        parser.add_argument('--teacher_type', type=str, default='rAg',
        ...
        parser.add_argument('--tokenizer_name', type=bool,
                            default=None, help='tokenizer_name')
