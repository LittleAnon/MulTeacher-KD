...
class DataTrainingArguments:
    ...
    glue_metrics_local_dir: Optional[str] = field(
        default="/root/program/data/datasets-master/metrics/glue",
        metadata={
...
cache_dict = {
    'bert' :['/root/program/embedding/bert_pretrained_model/bert-base','/root/program/embedding/bert_pretrained_model/bert/bert_mrpc'],
